            ...
            <div className={styles.listaHeader}>
              ...
              <div className={styles.statsGrid}>
                ...
                <div className={styles.statCard}>
                  <div className={styles.statIcon}>✅</div>
                  <div className={styles.statContent}>
                    <h3>{laboratorios.filter(lab => lab.status === "Ativo").length}</h3>
                    <p>Ativos</p>
                  </div>
                </div>
                <div className={styles.statCard}>
                  <div className={styles.statIcon}>❌</div>
                  <div className={styles.statContent}>
                    <h3>{laboratorios.filter(lab => lab.status === "Inativo").length}</h3>
                    <p>Inativos</p>
                  </div>
                </div>
              </div>
                  ...
                  {laboratoriosFiltrados.length > 0 ? (
                    laboratoriosFiltrados.map((lab) => (
                      <tr key={lab.id}>
                        ...
                        <td>{lab.telefone}</td>
                        <td>
                          <span className={`${styles.statusBadge} ${styles[lab.status.toLowerCase()]}`}>
                            {lab.status}
                          </span>
                        </td>
                        <td>
